...
replace github.com/google/go-metrics-stackdriver => github.com/minor-fixes/go-metrics-stackdriver v0.0.0-20230521160346-89eb28bba175
...
require (
	...
	github.com/hashicorp/go-metrics v0.4.2-0.20230519112806-858601465fcd // indirect
